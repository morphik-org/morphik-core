...
export class Agent extends APIResource {
   ...
   */
  processQuery(
    body: AgentProcessQueryParams,
    options?: RequestOptions,
  ): APIPromise<AgentProcessQueryResponse> {
    return this._client.post('/agent', { body, ...options });
  }
}

export type AgentProcessQueryResponse = { [key: string]: unknown };

export interface AgentProcessQueryParams {
  /**
