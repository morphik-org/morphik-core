...
describe('resource cloud', () => {
  ...
  test.skip('deleteApps: only required params', async () => {
    const responsePromise = client.cloud.deleteApps({ app_name: 'app_name' });
  ...
  // skipped: tests are disabled for the time being
  test.skip('deleteApps: required and optional params', async () => {
    const response = await client.cloud.deleteApps({ app_name: 'app_name' });
  });
