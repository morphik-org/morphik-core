...
class _AsyncScopedClientOps:
    ...
    async def list_documents_metadata(
        ...
        """List lightweight document metadata within this scope (async)."""
        effective_folder = self._merge_folders(additional_folders)
        return await self._client._scoped_list_documents_metadata(
            skip=skip,
            limit=limit,
            filters=filters,
            folder_name=effective_folder,
...
class AsyncMorphik(_ScopedOperationsMixin):
    ...
    async def list_documents_metadata(
        ...
        """
        return await self._scoped_list_documents_metadata(
            skip=skip,
            limit=limit,
            filters=filters,
            folder_name=folder_name,
