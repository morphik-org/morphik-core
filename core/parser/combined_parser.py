...
from core.models.time_series import TimeSeriesData  # python-magic library for file type detection
...
class CombinedParser(BaseParser):
    ...
    def _is_video_file(self, file_path: str = None, file_bytes: bytes = None, filename: str = None) -> bool:
        """
